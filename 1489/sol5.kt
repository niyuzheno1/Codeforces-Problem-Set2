...
fun solve() {
  val pos = IntArray(2*100000 + 10, {0})
  val pos2 = IntArray(2*100000 + 10, {0})
  val deque = IntArray(6*100000 , {0})
  var l = 6*100000/2
  var r = 6*100000/2
  var n = io.int()
  for(i in 1..n){
      ...
      if(opr[0].compareTo("?") == 0){
        var ans = min(pos[x]-l,r-pos2[x]);
        println("${ans-1}")
      }
  }
}
